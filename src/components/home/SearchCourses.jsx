...
const SearchCourses = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-slate-50 py-20 lg:py-28">
      ...
      <div className="absolute -top-32 -right-32 h-96 w-96 rounded-full bg-indigo-100/60 blur-3xl" />

      <div className="absolute -bottom-40 -left-40 h-[450px] w-[450px] rounded-full bg-blue-100/50 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-white px-4 py-2 shadow-sm">
            <span className="flex h-7 w-7 items-center justify-center rounded-full bg-indigo-50">
              <FiBookOpen className="text-indigo-600" size={14} />
            </span>
        ...
        {filteredCourses.length > 0 ? (
          <div className="mt-8 grid grid-cols-1 gap-7 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {filteredCourses.map((course) => (
              <div
                key={course.id}
                className="group overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-indigo-200 hover:shadow-2xl hover:shadow-slate-200/70"
              >
                ...
                <div className="relative h-56 overflow-hidden bg-slate-100">
                  ...
                  {/* Category Badge */}
                  <div className="absolute left-4 top-4 rounded-lg bg-white/95 px-3 py-1.5 text-xs font-bold text-indigo-600 shadow-sm backdrop-blur">
                    {course.category}
                  </div>

                  {/* Rating */}
                  <div className="absolute right-4 top-4 flex items-center gap-1.5 rounded-lg bg-slate-950/70 px-3 py-1.5 text-xs font-semibold text-white backdrop-blur">
                    <FiStar
                      size={13}
          ...
          <div className="mt-10 rounded-3xl border border-dashed border-slate-300 bg-white px-6 py-20 text-center">
            ...
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-indigo-50">
              <FiSearch size={26} className="text-indigo-600" />
            </div>
